...
| **The LLM gateway** — APISIX in front of the GenieX lanes: aliases, per-client keys, the GenieX rules (tools prompt, overflow fallback, T=0, timeouts), `serve-stack.sh`, the e2e test and the acceptance procedure | [llm-stack README, Gateway](../linux/llm-stack/README.md#gateway) |
