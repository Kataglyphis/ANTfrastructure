...
manifest holds **1257 entries** over **104 distinct test commands**; both digits are
...
on this tree, and the numbers say why. 503 definitions qualify, and nearly all are
