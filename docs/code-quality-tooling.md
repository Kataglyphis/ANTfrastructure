...
manifest holds **1266 entries** over **104 distinct test commands**; both digits are
...
on this tree, and the numbers say why. 509 definitions qualify, and nearly all are
