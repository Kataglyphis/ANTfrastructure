...
manifest holds **1341 entries** over **108 distinct test commands**; both digits are
...
on this tree, and the numbers say why. 514 definitions qualify, and nearly all are
