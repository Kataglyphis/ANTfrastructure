...
# Changelog archive — 2026-08-29 through 2026-09-07

Entries moved out of the root `CHANGELOG.md` on 2026-09-15 so the live file stays
readable (its own rule: archive past ~700 lines, never delete). Newest-first,
continuing where `CHANGELOG.md` stops and running back to where
[`changelog-archive-2026-08-28.md`](changelog-archive-2026-08-28.md) picks up.

Two mechanical edits, no rewording: relative links are re-based on this directory,
and the two `nas_census.py` paths point at OrchestrANT, which owns that tool now.
The out-of-order `## 2026-09-03 — the day with no entry` block travelled with the
2026-09-07 entries it was reconstructed beside.
...
* **The doc-links gate's two-sided bug.** One change made the gate ask git; another
  ...
  [`code-quality-tooling.md`](code-quality-tooling.md#generated-data-is-not-source-and-git-alone-cannot-say-so),
...
[`linux-host-setup.md` § D5](linux-host-setup.md#d5-pwsh-and-pytest--the-two-host-tools-preflight-needs-and-never-asked-for).
...
[`linux/llm-stack/tests/test_nas_census.py`](https://github.com/Kataglyphis/OrchestrANT/tree/main/benchmarks/tests/test_nas_census.py)
pin every classification gate on both sides of its threshold, and three new
`census.*` entries in [`docs/scripts/mutations.json`](scripts/mutations.json)
...
[`docs/windows-clang-cl-sanitizers.md`](windows-clang-cl-sanitizers.md).
...
[`docs/adopting-in-a-new-project.md`](adopting-in-a-new-project.md) § 8 has
...
[`docs/windows-build-invariants.md`](windows-build-invariants.md) § The host
...
[`docs/geniex-local-ai-setup.md` § Updating an existing install](geniex-local-ai-setup.md)
...
**New — [`docs/upstream-windows-patches.md`](upstream-windows-patches.md).**
...
[`docs/riscv64-rva23-baseline.md`](riscv64-rva23-baseline.md).
...
- [`docs/geniex-local-ai-setup.md`](geniex-local-ai-setup.md): new
...
- New docs section "Making room: WSL2 RAM tuning" in
  [`docs/geniex-local-ai-setup.md`](geniex-local-ai-setup.md): the
...
- Full measured envelope table added to
  [`docs/geniex-local-ai-setup.md`](geniex-local-ai-setup.md): NPU
...
[`docs/geniex-local-ai-setup.md`](geniex-local-ai-setup.md) § The NPU
...
New page [`docs/geniex-local-ai-setup.md`](geniex-local-ai-setup.md):
